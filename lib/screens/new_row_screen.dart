...
class _NewRowScreenState extends State<NewRowScreen> {
        ...
        child: ListView(
          ...
          children: [
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Объект/участок (необязательно)'),
            ),
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              decoration: const InputDecoration(labelText: 'Вид работ'),
              value: _typeId,
              items: Catalog.types.map((e) => DropdownMenuItem(
                value: e.id,
                child: Text(e.name),
              )).toList(),
            ...
            Wrap(
              ...
              children: [
                ...
                SizedBox(width: 180, child: _intField('Кол-во одинаковых', _countCtrl)),
                if (fields.contains(Field.manualQty)) SizedBox(width: 180, child: _field('Кол-во', _manualQtyCtrl, 'ед.')),
                if (fields.contains(Field.manualUnit)) SizedBox(width: 180, child: TextFormField(
                  controller: _manualUnitCtrl,
                  decoration: const InputDecoration(labelText: 'Ед. изм. (текст)'),
                )),
              ],
            ),
            const SizedBox(height: 12),
            TextFormField(
              ...
              decoration: InputDecoration(labelText: 'Цена за 1 ${unitLabel} (ввод вручную)'),
  ...
  TextFormField _intField(String label, TextEditingController c) {
    return TextFormField(
      controller: c,
