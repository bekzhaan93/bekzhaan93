          ...
          children: [
            ...
            FilledButton.icon(
              ...
              onPressed: () async {
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('CSV сохранён: $path')));
                await Share.shareXFiles([XFile(path)], text: 'BoQCalc — экспорт');
              },
            ),
